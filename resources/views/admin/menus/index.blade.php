            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <div class="layui-input-inline ">
                        <button class="layui-btn layui-btn-xs"  onclick="xadmin.open('添加菜单','{{ url('admin/menus/create') }}', 500, 600)" ><i class="layui-icon">&#xe608;</i>新增菜单</button>
                    </div>
                    <hr>
                    ...
                    <table class="layui-table layui-form">
                        ...
                        @foreach($menulist as $v)
                            <tr cate-id='{{ $v->id }}' fid='{{ $v->pid }}' >
                                ...
                                <td class="td-manage">
                                    <button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('菜单编辑','{{ route('menus.edit',['id'=>$v->id]) }}', 500, 600)" ><i class="layui-icon">&#xe642;</i>编辑</button>
