            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <div class="layui-input-inline ">
                        <button class="layui-btn layui-btn-xs"  onclick="xadmin.open('新建权限','{{ url('admin/permissions/create') }}', 500, 600)" ><i class="layui-icon">&#xe608;</i>新增权限</button>
                    </div>
                    <hr>
                        ...
                        @foreach($permissionlist as $v)
                            ...
                            @else
                                <tr cate-id='{{ $v['id'] }}' fid='{{ $v['cate_id'] }}' >
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('权限编辑','{{ route('permissions.edit',['id'=>$v['id']]) }}', 500, 600)" ><i class="layui-icon">&#xe642;</i>编辑</button>
